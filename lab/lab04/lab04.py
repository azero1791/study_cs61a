...
def reverse_recursive(lst):
    ...
    if len(lst) == 1 or len(lst) == 0:
        ...
        return reverse_recursive(lst[1:len(lst)]) + lst[0:1]
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    city_des = make_city('destination', lat, lon)
    return get_name(city_a) if distance(city_a, city_des) < distance(city_b, city_des) else get_name(city_b)
